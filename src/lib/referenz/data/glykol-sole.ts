...
export const glykolSole: ReferenceTable = {
	...
	description_en: 'Properties of ethylene glycol-water mixtures at 20 °C. Important for heat pump brine circuits and refrigeration systems.',
	columns: [
		{ key: 'pct', label: 'Glykol-Anteil', label_en: 'Glycol content', unit: '%', type: 'number', mono: true, highlight: true },
		{ key: 'freeze', label: 'Gefrierpunkt', label_en: 'Freezing point', unit: '°C', type: 'number', highlight: true },
		{ key: 'rho', label: 'Dichte ρ', label_en: 'Density ρ', unit: 'kg/m³', type: 'number' },
		{ key: 'cp', label: 'Wärmekapazität cp', label_en: 'Heat capacity cp', unit: 'kJ/(kg·K)', type: 'number' },
		{ key: 'nu', label: 'Kinemat. Viskosität ν', label_en: 'Kinematic viscosity ν', unit: 'mm²/s', type: 'number' },
		{ key: 'lambda', label: 'Wärmeleitung λ', label_en: 'Thermal conductivity λ', unit: 'W/(m·K)', type: 'number' }
	],
	rows: [
	...
	notes_en: 'Heat pump rule of thumb: brine inlet temperature should be ≥ 7 K above freezing point as a safety margin; ≥ 10 K under adverse conditions. Propylene glycol (food-safe) has higher viscosity and lower heat capacity.'
};
