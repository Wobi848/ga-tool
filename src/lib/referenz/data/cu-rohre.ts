	...
	rows: [
		{
			...
			id: 10.0,
			mass: 0.308,
			use: 'Anbindung Sanitär',
			use_en: 'Plumbing connection'
		},
		{
			name: '15 × 1.0',
			od: 15,
			...
			id: 13.0,
			mass: 0.391,
			use: 'Standard Sanitär',
			use_en: 'Standard plumbing'
		},
		{
			name: '18 × 1.0',
			od: 18,
			...
			id: 16.0,
			mass: 0.475,
			use: 'Heizkörper-Anbindung',
			use_en: 'Radiator connection'
		},
		{
			name: '22 × 1.0',
			od: 22,
		...
		},
		{
			...
			id: 25.0,
			mass: 1.11,
			use: 'Verteilleitungen',
			use_en: 'Distribution pipes'
		},
		{
			name: '35 × 1.5',
			od: 35,
		...
		},
		{
			...
			id: 50.0,
			mass: 2.91,
			use: 'Hauptstrang gross',
			use_en: 'Large main run'
		},
		{
			name: '64 × 2.0',
			od: 64,
		...
		},
		{
			...
			id: 72.1,
			mass: 4.149,
			use: 'Hauptverteilung gross',
			use_en: 'Large main distribution'
		},
		{
			name: '88.9 × 2.0',
			od: 88.9,
			...
			id: 84.9,
			mass: 4.864,
			use: 'Selten in Hausinstallation',
			use_en: 'Rarely used in domestic installation'
		}
	],
	notes:
		'Kupferrohre nach EN 1057 — R220 (weich), R250 (halbhart), R290 (hart). Trinkwasserzulassung beachten.',
	notes_en:
		'Copper pipes per EN 1057 — R220 (soft), R250 (half-hard), R290 (hard). Check drinking water approval.'
};
