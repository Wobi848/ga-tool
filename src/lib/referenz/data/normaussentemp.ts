...
export const normaussentemp: ReferenceTable = {
	...
	updated: '2026-05-14',
	description:
		'Norm-Aussentemperatur für Heizlast-Berechnung (Ortsklimadaten). Massgebend für Heizungsdimensionierung und Heizkurve.',
	description_en:
		'Design outdoor temperature for heating load calculation (local climate data). Decisive for heating system sizing and heating curve.',
	columns: [
		{ key: 'ort', label: 'Ort', label_en: 'Location', highlight: true },
		{ key: 'kanton', label: 'Kanton', label_en: 'Canton', mono: true },
		{
			key: 'temp',
			label: 'Norm-Aussentemp',
			label_en: 'Design OAT',
			unit: '°C',
			type: 'number',
			highlight: true
	...
	notes:
		'Werte gemäss SIA 384/2 (2020). Bei Standorten dazwischen mit Höhenkorrektur (~0.5 K pro 100 m Höhendifferenz) interpolieren.',
	notes_en:
		'Values per SIA 384/2 (2020). Interpolate for intermediate locations using altitude correction (~0.5 K per 100 m altitude difference).'
};
