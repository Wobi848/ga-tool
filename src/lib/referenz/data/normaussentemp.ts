...
export const normaussentemp: ReferenceTable = {
	...
	columns: [
		{ key: 'ort', label: 'Ort', highlight: true },
		{ key: 'kanton', label: 'Kanton', mono: true },
		{ key: 'temp', label: 'Norm-Aussentemp', unit: '°C', type: 'number', highlight: true },
		{ key: 'altitude', label: 'Höhe', unit: 'm ü. M.', type: 'number' }
	],
	rows: [
