	...
	units: [
		{
			...
			labelEn: 'Degrees',
			symbol: '°',
			note: 'Klappenantriebe 0–90° oder 0–180°',
			noteEn: 'Damper actuators 0–90° or 0–180°'
		},
		{ id: 'rad', label: 'Radiant', labelEn: 'Radian', symbol: 'rad' },
		{
			id: 'pct90',
			label: 'Prozent (0–90°)',
			labelEn: 'Percent (0–90°)',
			symbol: '% (90°)',
			note: 'Typisch Brandschutzklappen',
			noteEn: 'Typical fire dampers'
		},
		{
			id: 'pct180',
			label: 'Prozent (0–180°)',
			labelEn: 'Percent (0–180°)',
			symbol: '% (180°)',
			note: 'Typisch Mischventile',
			noteEn: 'Typical mixing valves'
		},
