export const de = {
	...
	objekte: {
		title: 'Objekte',
		subtitle: 'Gebäude, Anlagen und die Checklisten, die dazugehören.',
		neu: 'Neues Objekt',
		name: 'Name',
		namePlaceholder: 'z. B. Wohnüberbauung Seefeld, Baufeld B',
		adresse: 'Adresse',
		...
		reaktivieren: 'Zurückholen',
		loeschen: 'Löschen',
		loeschenFrage:
			'Objekt mit allen Anlagen und Durchläufen löschen? Das lässt sich nicht rückgängig machen.',
		keine: 'Noch keine Objekte.',
		keineHinweis:
			'Ein Objekt ist die Klammer um alles, was zu einem Gebäude gehört — Anlagen, Checklisten, Notizen.',
		archivierteZeigen: 'Archivierte zeigen',
		archiviert: 'archiviert',
		zurueck: 'Alle Objekte',
		anlagen: 'Anlagen',
		anlageNeu: 'Anlage hinzufügen',
		anlageName: 'Bezeichnung',
		anlageNamePlaceholder: 'z. B. Lüftung MZ1',
		anlageLoeschenFrage:
			'Anlage löschen? Die Durchläufe bleiben und hängen danach direkt am Objekt.',
		keineAnlagen: 'Keine Anlagen — Durchläufe hängen direkt am Objekt.',
		ohneAnlage: 'Ohne Anlage',
		durchlaeufe: 'Durchläufe',
		durchlaufNeu: 'Checkliste starten',
		durchlaufTitel: 'Bezeichnung',
		durchlaufTitelPlaceholder: 'z. B. IBN Lüftung MZ1',
		vorlage: 'Vorlage',
		vorlageWaehlen: 'Vorlage wählen…',
		keineDurchlaeufe: 'Noch keine Checkliste gestartet.',
		fortschritt: 'Fortschritt',
		erledigt: 'erledigt',
		abgeschlossen: 'abgeschlossen',
		wiederOeffnen: 'Wieder öffnen',
		abschliessen: 'Abschliessen',
		durchlaufLoeschenFrage: 'Diesen Durchlauf mitsamt Häkchen und Notizen löschen?',
		oeffnen: 'Öffnen',
