export const en = {
	...
	objekte: {
		title: 'Sites',
		subtitle: 'Buildings, plants and the checklists that belong to them.',
		neu: 'New site',
		name: 'Name',
		namePlaceholder: 'e.g. Seefeld residential development, plot B',
		adresse: 'Address',
		auftraggeber: 'Client',
		notiz: 'Note',
		anlegen: 'Create',
		...
		loeschen: 'Delete',
		loeschenFrage: 'Delete site with all plants and checklist runs? This cannot be undone.',
		keine: 'No sites yet.',
		keineHinweis:
			'A site brackets everything that belongs to one building — plants, checklists, notes.',
		archivierteZeigen: 'Show archived',
		archiviert: 'archived',
		zurueck: 'All sites',
		anlagen: 'Plants',
		anlageNeu: 'Add plant',
		anlageName: 'Label',
		anlageNamePlaceholder: 'e.g. AHU 1',
		anlageLoeschenFrage: 'Delete plant? Its runs stay and will attach directly to the site.',
		keineAnlagen: 'No plants — runs attach directly to the site.',
		ohneAnlage: 'No plant',
		durchlaeufe: 'Checklist runs',
		durchlaufNeu: 'Start checklist',
		durchlaufTitel: 'Label',
		durchlaufTitelPlaceholder: 'e.g. Commissioning AHU 1',
		vorlage: 'Template',
		vorlageWaehlen: 'Choose template…',
		keineDurchlaeufe: 'No checklist started yet.',
		fortschritt: 'Progress',
		erledigt: 'done',
		abgeschlossen: 'completed',
		wiederOeffnen: 'Reopen',
		abschliessen: 'Complete',
		durchlaufLoeschenFrage: 'Delete this run including ticks and notes?',
		oeffnen: 'Open',
