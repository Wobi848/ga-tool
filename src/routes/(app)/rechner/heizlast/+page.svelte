<script lang="ts">
	...
	function updateRoom(id: number, field: keyof Raum, value: number | string) {
		rooms = rooms.map((r) =>
			r.id === id ? { ...r, [field]: typeof value === 'string' ? value : value } : r
		);
	}
</script>
...
<div class="calc-page">
					...
					<div class="room-detail">
						<div class="detail-grid">
							<div class="detail-field">
								...
								<input
									...
									type="text"
									value={r.label}
									oninput={(e) => updateRoom(r.id, 'label', (e.target as HTMLInputElement).value)}
									class="detail-input"
								/>
							</div>
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.ti}
										oninput={(e) =>
											updateRoom(r.id, 'ti', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.area}
										oninput={(e) =>
											updateRoom(r.id, 'area', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.height}
										oninput={(e) =>
											updateRoom(r.id, 'height', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
									<span class="detail-unit">m</span>
								</div>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.uWall}
										oninput={(e) =>
											updateRoom(r.id, 'uWall', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.uRoof}
										oninput={(e) =>
											updateRoom(r.id, 'uRoof', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
									<span class="detail-unit">W/m²K</span>
								</div>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.uFloor}
										oninput={(e) =>
											updateRoom(r.id, 'uFloor', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
									<span class="detail-unit">W/m²K</span>
								</div>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.uWindow}
										oninput={(e) =>
											updateRoom(r.id, 'uWindow', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
									<span class="detail-unit">W/m²K</span>
								</div>
							...
							<div class="detail-field">
								...
								<div class="detail-wrap">
									<input
										...
										value={r.ach}
										oninput={(e) =>
											updateRoom(r.id, 'ach', parseFloat((e.target as HTMLInputElement).value))}
										class="detail-input detail-num"
									/>
						...
						<button
							...
							onclick={() => {
								removeRoom(r.id);
								selectedId = null;
							}}>{$_('rechner.heizlastUi.removeRoom')}</button
						>
					</div>
				{/if}
			</div>
	...
	<div class="calc-result-section">
		<div class="calc-result">
			...
			<span class="calc-result-value primary"
				>{fmt(totalLoad, 0)}<span class="calc-result-unit">W</span></span
			>
		</div>
		<div class="calc-result">
			<span class="calc-result-label">{$_('rechner.heizlastUi.totalHeatload')}</span>
			<span class="calc-result-value"
				>{fmt(totalLoad / 1000, 2)}<span class="calc-result-unit">kW</span></span
			>
		</div>
		<div class="calc-result">
		...
		<div class="calc-result">
			...
			<span class="calc-result-value"
				>{fmt(totalArea, 0)}<span class="calc-result-unit">m²</span></span
			>
		</div>
	</div>
	...
	<div class="benchmark">
		...
		<span class="bm-item" style="color:#dc2626"
			>{$_('rechner.heizlastUi.benchmarkUninsulated')}</span
		>
	</div>
