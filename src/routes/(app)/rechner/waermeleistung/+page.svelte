<script lang="ts">
	...
	const mediaPropsBase: Record<Medium, { labelKey: string; noteKey: string; cp: number; rho: number }> = {
		wasser: { labelKey: 'rechner.waermeleistungUi.water', noteKey: 'rechner.waermeleistungUi.waterNote', cp: 4.182, rho: 1000 },
		sole30: { labelKey: 'rechner.waermeleistungUi.brine30', noteKey: 'rechner.waermeleistungUi.brine30Note', cp: 3.78, rho: 1050 },
		sole40: { labelKey: 'rechner.waermeleistungUi.brine40', noteKey: 'rechner.waermeleistungUi.brine40Note', cp: 3.6, rho: 1065 },
		luft:   { labelKey: 'rechner.waermeleistungUi.air',   noteKey: 'rechner.waermeleistungUi.airNote',   cp: 1.006, rho: 1.2 }
	};
...
<div class="calc-page">
	<header class="calc-header">
		...
		<div class="calc-title-row">
			...
			<FavButton type="rechner" slug="waermeleistung" title={$_('rechner.waermeleistung.name')} size={20} />
		</div>
	</header>
	...
	<div class="calc-section">
		...
		<div class="calc-field" style="border-top: none">
			<label class="calc-field-label" for="mode-sel">{$_('rechner.waermeleistungUi.calcMode')}</label>
	...
	<div class="calc-section">
		...
		{#if mode !== 'flow-from-q'}
			<div class="calc-field">
				<label class="calc-field-label" for="flow-in">{$_('rechner.waermeleistungUi.volumeFlow')}</label>
